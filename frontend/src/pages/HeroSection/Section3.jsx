  ...
  return (
    <div className='p-8 md:px-16 lg:p-35'>
      <div className='flex flex-col md:flex-row justify-between bg-lightblack text-white rounded-4xl p-5 md:p-20  gap-20 md:gap-0 items-center'>
        <div className='grid gap-8 justify-items-center-center text-center md:text-left'>
            <h1 className='font-semibold text-2xl'>Do You Own a Luxury Car?</h1> 
           ...
           <button className='mx-auto md:mx-0 bg-white text-black font-semibold rounded-lg px-7 py-3 max-w-45 cursor-pointer hover:bg-gray-200 transition-colors duration-300 scale-100 hover:scale-105'>List your Car</button>
        </div>
