...
const ConformModel = ({onConform,onCancel,title}) => {

    const {showconfirm,setShowConfirm}=useAppContext();
  ...
  return (
    <div className="flex flex-col items-center bg-white shadow-md rounded-xl py-6 px-5 md:w-[460px] w-[370px] border border-gray-200">
            ...
            <div className="flex items-center justify-center gap-4 mt-5 w-full">
                ...
                <button type="button" onClick={onConform} className="w-full md:w-36 h-10 cursor-pointer rounded-md text-white bg-red-600 font-medium text-sm hover:bg-red-700 active:scale-95 transition">
                    Confirm
                </button>
            </div>
        </div>
